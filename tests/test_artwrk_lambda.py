...
class TestArtWrkLambda(unittest.TestCase):
    ...
    def test_lambda_handler(self):
        ...
        # self.assertEqual(lambda_handler(test_data.get_all_jobs,"context"),test_data.success)
        # self.assertEqual(lambda_handler(test_data.get_all_posts,"context"),test_data.success)
